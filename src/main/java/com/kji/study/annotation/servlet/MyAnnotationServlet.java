 ...
 * http://localhost:8080/MyAnnotationServlet 을 통해 테스트 가능 
 *
 */
@WebServlet(description = "first Servlet", displayName = "MyAnnotationServlet", name = "MyAnnotationServlet", urlPatterns = {
	"/MyAnnotationServlet"
}, initParams = {
